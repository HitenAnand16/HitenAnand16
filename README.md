...
I'm a **Software Developer at [Multyfi](https://github.com/multyfi)** who loves taking an idea and shipping it as a polished, production-grade mobile app.

I architected Multyfi's flagship **iOS + Android** stock-advisory app from the ground up, and I care a lot about clean architecture, smooth UX and performance.

- 📱 &nbsp;Building cross-platform apps with **React Native**
- 📈 &nbsp;Working on a **real-time stock advisory platform**
- 💳 &nbsp;Payments, analytics and **attribution SDKs** in production
- 🧭 &nbsp;Levelling up in **Python, DSA, Swift and AI/ML**
- 🤝 &nbsp;Led a team of 3 — I enjoy mentoring and cross-functional work
- 🎓 &nbsp;BCA, IITM Janakpuri (2021 – 2024)
...
<img src="https://img.shields.io/badge/Cashfree-6C2BD9?style=flat-square" />
...
### 🚀 &nbsp;Software Developer · Multyfi
`May 2025 – Present`

- Architected the flagship **cross-platform app (iOS & Android)** from zero to production
- Scalable navigation + **Context API** state architecture
- **Real-time live stock prices** via optimised API polling
- Integrated **Cashfree payments**, **Facebook / Google event tracking** and **MMP attribution**
- Platform tuning: lower startup latency, better rendering, fewer crashes

`React Native` &nbsp;`JavaScript` &nbsp;`Swift` &nbsp;`Python` &nbsp;`Firebase`

</td>
<td width="50%" valign="top">

### ⚡ &nbsp;Software Developer · Aforro
`Sep 2024 – Apr 2025`

- Shipped **29+ screens** in a React Native app within two months
- **Led a team of 3 developers** — guidance, reviews, on-time delivery
- Built a **FastAPI backend** for auth, product APIs and real-time orders
- Owned stakeholder communication across teams

`React Native` &nbsp;`JavaScript` &nbsp;`Redux` &nbsp;`FastAPI`
...
📦 &nbsp;**Full production app** shipped within 6 months of joining &nbsp;•&nbsp; ⚡ &nbsp;**~30% better** app state efficiency &nbsp;•&nbsp; 📊 &nbsp;**Analytics pipelines** integrated

</div>

<img width="100%" src="https://user-images.githubusercontent.com/74038190/212284100-561aa473-3905-4a80-b561-0d28506553ee.gif" alt="" />

## 📂 Things I've Built Publicly
...
<a href="mailto:hitenanand2402@gmail.com"><img src="https://img.shields.io/badge/Say%20Hello-EA4335?style=for-the-badge&logo=gmail&logoColor=white"/></a>

<br><br>

<i>⭐ Feel free to explore my repositories — and star anything you find useful!</i>
